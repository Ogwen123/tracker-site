                        ...
                        />
                        {
                            [...Array(10)].map((_, index) => {
                                return (
                                    <div
                                        key={index}
                                        className={"size-6 rounded-lg white-border my-[3px] border-[2px] outline-offset-2 " + (colour === index ? "border-[" + colourMap[index] + "]" : "border-bgdark")}
                                        style={{ backgroundColor: colourMap[index] }}
                                        onClick={() => {

        ...
        <div className="flex px-[20px] items-center h-[90px] bg-bgdark">
            ...
            {context.user && (
                <div className="flex h-full items-center">
                    ...
                    <div className="w-[1px] bg-hr h-[40%] mx-[10px]"></div>
                    <Link
                        reloadDocument
                        to="/tasks"
                        className="flex items-center"
            ...
            <Menu>
                ...
                >
                    {context.user === undefined ? (
                        <div>
                            <MenuItem as="div">
                                <div className="fc m-[10px]">Not logged in</div>
                            </MenuItem>
                            ...
                            <MenuItem>
                                <Link
                                    reloadDocument
                                    to="/login"
                                    className="group flex w-full items-center gap-2 rounded-md py-1.5 px-3 data-[focus]:bg-white/10"
                                >

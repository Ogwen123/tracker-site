    ...
    return show ? (
        ...
        >
            <div
                className={
                    colour1 +
                    " fc h-full w-[50px] p-[5px] rounded-tl-md rounded-bl-md"
                }
            >
                {severity === "ERROR" ? (
            ...
            <div
                className={
                    colour2 +
                    "  flex flex-col w-full items-center py-[5px] px-[10px] rounded-tr-md rounded-br-md"
                }
            >
                ...
                <div
                    className={
                        "w-full h-[47px] text-md overflow-hidden flex items-center"
                    }
                >
                    {content}
                </div>

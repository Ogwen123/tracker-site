    ...
    React.useEffect(() => {
        ...
        fetch(url("tracker") + "task", {
            ...
            .catch((err) => {
                console.error(err);
                setAlert([
                    "An unknown error occured whilst fetching the tasks data.",
                    "ERROR",
                    true,
                ]);
            });
                        ...
                        {showEditForm ? (
                            ...
                            <div className="flex flex-row flex-wrap">
                                ...
                                <div className="w-1/3">
                                    ...
                                    <div>{title(task.repeat_period)}</div>
                                </div>
                                <div className="w-1/3">
                                    <div className="text-subtext">
                                        Created At
                                    </div>
                                    <div>{ISOToTime(task.created_at)}</div>
                                </div>
                                    ...
                                    <div className="flex flex-col w-full">
                                        ...
                                        <div className="flex flex-row flex-wrap w-full">
                                            <div className="w-1/3">
                                                ...
                                                <div>
                                                    {title(
                                                        task.week_of_repeat_period as string,
                                                    )}
                                                </div>
                                            </div>
                                            <div className="w-1/3">
                        ...
                        {task.repeat_period !== "NEVER" ? (
                            task.completed ? (
                                <div className="text-lg font-bold text-subtext">
                                    This task will reset in{" "}
                                    <span className="text-main">
                                        {secondsToTime(timeRemaining)}
                                    </span>
                                </div>
                            ) : (
                                <div className="text-lg font-bold text-subtext">
                        ...
                        <div className="bg-bgdark rounded-md w-full p-[10px] flex mb-[20px] flex-row justify-evenly">
                            ...
                            <div className="white-border size-[250px] rounded-md border-[2px] flex flex-col">
                                ...
                                <div className="w-full text-center text-subtext/70 pb-[10px] text-xs">
                                    Total completions as a percentage of total
                            ...
                            {task.completions === 0 ? (
                                ...
                                <div>
                                    <div className="text-xl">
                                        Last {task.task_completions.length} task
                                        completions
                                    </div>
                                        ...
                                        {task.task_completions.map(
                                            (completion, index) => {
                                                ...
                                                return (
                                                    <div
                                                        key={index}
                                                        className="flex flex-row justify-evenly rounded-md white-border w-[1000px] mt-[10px]"
                                                    >
                                                        <div className="w-[100px] text-center">
                                                            {date}
                                                        </div>

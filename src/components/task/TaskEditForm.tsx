...
const TaskEditForm = ({ updateTask, task, setShowEditForm }: TaskEditFormProps) => {
    ...
    const submit = () => {
        setSubmitting(true)
        if (task.date_time) { // validate the hours and minutes
        ...
        if (taskBuffer.date_time === true) { // if the date time is turned on then add the nessessary data to the body 
            ...
            <div className='flex flex-row flex-wrap'>
                <div className='w-1/3'>
                    ...
                    <div>
                        <input
                            ...
                            onChange={(e) => setTaskBuffer((prevTask) => ({ ...prevTask, name: e.target.value }))}
                ...
                <div className='w-1/3'>
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            setTaskBuffer((prevTask) => ({ ...prevTask, date_time: e.target.checked }))

                            if (taskBuffer.day === null) {
                                console.log("setting day")
                                setTaskBuffer((prevTask) => ({ ...prevTask, day: "MONDAY" }))
                            }
                            if (taskBuffer.hour === null) {
                                console.log("setting hour")
                                setTaskBuffer((prevTask) => ({ ...prevTask, hour: 12 }))
                            }
                            if (taskBuffer.minute === null) {
                                console.log("setting minute")
                                setTaskBuffer((prevTask) => ({ ...prevTask, minute: 0 }))
                            }
                                ...
                                <div>
                                    {
                                        task.repeat_period !== "WEEK" ?
                                            <Select
                                                ...
                                                value={taskBuffer.week_of_repeat_period as string}
                                                onChange={(e) => setTaskBuffer((prevTask) => ({ ...prevTask, week_of_repeat_period: e.target.value as Week }))}>
                            ...
                            <div className='w-1/3'>
                                ...
                                <div>
                                    <select
                                        ...
                                        onChange={(e) => setTaskBuffer((prevTask) => ({ ...prevTask, day: e.target.value as Day }))}
                                    >
                            ...
                            <div className='w-1/3'>
                                ...
                                <div className='flex flex-row'>
                                    <input
                                        ...
                                        onChange={(e) => setTaskBuffer((prevTask) => ({ ...prevTask, hour: e.target.valueAsNumber }))}
                                        max={12}
                                        min={0}
                                    />
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setTaskBuffer((prevTask) => ({ ...prevTask, minute: e.target.valueAsNumber }))}
                                        max={60}
                                        min={0}
                                    />
                                </div>

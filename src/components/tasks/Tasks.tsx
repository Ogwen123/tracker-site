    ...
    return (
        <div className='page-parent'>
            ...
            <ShowUser>
                ...
                <NewTaskDialog open={newDialog} setOpen={setNewDialog} updateTasks={updateTasks} page={page} />
                    ...
                    <TabGroup
                        ...
                        <TabList className="flex w-full justify-between flex-wrap" >
                            ...
                            <Tab className="tab fc group">
                                Never
                                <InformationCircleIcon className='size-5 ml-[5px] text-text' title="When a task that is set to never repeat is completed it will be removed from this page but you will be able to view it in your dashboard." />
                            </Tab>
